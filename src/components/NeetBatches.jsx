...
const NeetBatches = () => {
  ...
  return (
    <div>
        <Navbar/>
    <div className="bg-[#131827] min-h-screen text-[#1f2937] py-10 pt-[6rem] px-6 pb-[6rem] relative">
      ...
      <div className="max-w-7xl mx-auto text-center mb-10 px-4">
        <p className="text-white text-base md:text-lg leading-relaxed">
          Joining a dedicated <span className="text-[#FCA311] font-semibold">NEET 2026</span> batch is a transformative step for students aspiring to excel in one of India’s most competitive medical entrance exams.
          ...
          At <span className="text-[#FCA311] font-semibold">Docengo</span>, our NEET batches are crafted to guide students through every stage of their journey — from understanding concepts to mastering exam strategies.
          Below, explore how our <span className="text-[#FCA311] font-semibold">NEET 2026</span> batches can help you stay ahead with precision, discipline, and clarity.
        </p>
      </div>
      ...
      <div className='flex flex-col lg:flex-row gap-[2rem] justify-center items-start'>
        ...
        {/* Right Side BBP Image Card */}
         <div className='rounded-lg w-[25rem] h-[39rem] border-[1px] text-center border-white shadow-lg shadow-gray-400 mt-[2rem]'>
            ...
            <button className='bg-[#FCA311] text-white font-semibold px-4 py-2 mt-2 rounded-lg hover:bg-[#e89900] transition'
                 onClick={() => {
                        window.open(
                    "https://wa.me/918882153238?text=Hi%2C%20I'm%20interested%20in%20your%20NEET%202026%20batch",
                    "_blank"
                    );
                 }}
            >
