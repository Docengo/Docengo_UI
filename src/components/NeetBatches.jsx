...
const NeetBatches = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-[#131827] min-h-screen text-[#1f2937] py-10 pt-[6rem] px-4 pb-20 relative">
        {/* Title */}
        ...
        {/* Content Layout */}
        <div className="flex flex-col lg:flex-row gap-y-10 gap-x-10 justify-center items-center">
          {/* Batches Grid */}
